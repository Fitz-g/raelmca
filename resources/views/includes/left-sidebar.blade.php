...
{{--                <li>--}}
{{--                    <a href="{{ route('pays.index') }}" class="waves-effect"><i class="ti-calendar"></i><span> Pays </span></a>--}}
{{--                </li>--}}

                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="fas fa-users"></i><span> Membres <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="#" class="waves-effect"><span> Liste </span></a></li>
                        <li><a href="#" class="waves-effect"><span> Ajouter </span></a></li>
                    </ul>
                </li>
                
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="fas fa-location-arrow"></i><span> Pays <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="{{ route('pays.index') }}" class="waves-effect"><span> Liste </span></a></li>
                        <li><a href="{{ route('pays.create') }}" class="waves-effect"><span> Créer </span></a></li>
                    </ul>
                </li>
