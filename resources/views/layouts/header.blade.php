...
{{--           <img src="{{ asset('assets/images/logo-light.png') }}" alt="" height="18">--}}
       <p style="font-weight:bold;color:white;margin-top:20px" class="">
           <img src="{{ asset('assets/images/logo-sm.png') }}" alt="" height="40">
           <strong>RAELMCA</strong>
       </p>
    </span>
       <i>
           <img src="{{ asset('assets/images/logo-sm.png') }}" alt="" height="40">
    ...
    <ul class="navbar-right d-flex list-inline float-right mb-0">
        ...
        <li class="dropdown notification-list d-none d-md-block">
            <a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                <img src="{{ asset('assets/images/flags/french_flag.jpg') }}" class="mr-2" height="12" alt=""/> Français <span class="mdi mdi-chevron-down"></span>
            </a>
...
{{--                    <a class="dropdown-item" href="#"><i class="mdi mdi-lock-open-outline m-r-5"></i> Lock screen</a>--}}
                    ...
                    <a class="dropdown-item text-danger" href="{{ route('user-logout') }}"><i class="mdi mdi-power text-danger"></i> Déconnexion</a>
                </div>
            </div>
        </li>
